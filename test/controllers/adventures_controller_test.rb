...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { coordinates: @adventure.coordinates, date: @adventure.date, integer: @adventure.integer, location: @adventure.location }
    end
  ...
  test "should update adventure" do
    patch :update, id: @adventure, adventure: { coordinates: @adventure.coordinates, date: @adventure.date, integer: @adventure.integer, location: @adventure.location }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
